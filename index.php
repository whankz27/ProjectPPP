...
$tahunSaatIni = date('Y');
// Jika pengguna telah logout, arahkan kembali ke halaman login
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <input class="form-control col-sm" id="tahun_ppp" name="tahun_ppp" value="<?php echo $tahunSaatIni; ?>" readonly />
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <label>&nbsp;</label>
                                                                    <div>
                                                ...
                                                <div class="card shadow mb-4">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-user" id="namaAgentLJH" name="namaAgentLJH" value="<?= $row['username']; ?>" readonly>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="kantorLJH">Kantor</label>
                                                            <input type="text" class="form-control form-control-user" id="kantorLJH" name="kantorLJH" value="<?= $row['kantor'] ?>" readonly>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="noHpAgent">HP</label>
                                                            <input type="text" class="form-control form-control-user" id="noHpAgent" name="noHpAgent" value="<?= $row['hp'] ?>" readonly>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="telpKantor">Telp Kantor</label>
                                                            <input type="text" class="form-control form-control-user" id="telpKantor" name="telpKantor" value="(021)40 000 916 " readonly>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="emailAgent">Email</label>
                                                            <input type="text" class="form-control form-control-user" id="emailAgent" name="emailAgent" value="<?= $row['email'] ?>" readonly>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="alamatAgent">Alamat</label>
                                                            <textarea class="form-control" id="alamatAgent" name="alamatAgent" rows="4" style="resize: none;" readonly><?= $row['alamat'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
