                                        ...
                                        try {
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td> 
                                                    <a href='edit.php?id=" . $row['no_ppp'] . "' title='Edit'><i class='fas fa-edit'></i></a> |
                                                    <a href='view.php?id=" . $row['no_ppp'] . "' title='View'><i class='fas fa-eye'></i></a> |
                                                    <a href='../controller/delete.php?id=" . $row['no_ppp'] . "' title='Delete'><i class='fas fa-trash'></i></a>
                                                    </td>";
                                                    echo "</tr>";
                                                }
                                            } else {
